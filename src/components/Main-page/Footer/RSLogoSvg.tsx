function RSLogoSvg(): JSX.Element {
  return (
    <svg
      id="Layer_1"
    ...
    >
      <style>
        {
          ".st0{fill:#fff}.st5,.st7{fill:#fff;stroke:#000;stroke-width:4;stroke-miterlimit:10}.st7{fill:none}"
        }
      </style>
      ...
      <g clipPath="url(#SVGID_2_)">
        ...
        <g id="Layer_2_1_">
          ...
          <g id="Layer_1-2" clipPath="url(#SVGID_4_)">
            <ellipse
              transform="rotate(-37.001 420.46 67.88)"
              className="st0"
              cx={420.5}
