...
import SectionIcon from '../Textbook/GroupIcon';
...
export default function Group({ group, handleSetGroup }: Props) {
  ...
  return (
    <div className="relative">
      <button
        className="flex items-center justify-center gap-x-3 max-w-max px-3 py-1 text-white text-base font-medium 
