...
export default function Word({
  ...
  return (
    <article className="flex flex-col w-full bg-blue-100 rounded-lg text-blue-400 md:flex-row lg:max-w-5xl">
      <img
        alt={`${word} illustration`}
        className="rounded-t-lg md:max-w-xs md:rounded-none md:rounded-l-lg"
