  ...
  return (
    <section>
      <section className="flex flex-wrap justify-around mx-5">
        ...
        <div className="flex justify-center grow shrink min-w-[50%] space-x-4 font-medium bg-contain bg-no-repeat h-80 bg-center"
          style={{
            backgroundImage: `url(./assets/img/main.png)`,
          }} />
      </section>
      <section>
        <h2 className="font-medium text-slate-700/600 pt-3 pb-2 text-center text-4xl mx-4" >Преимущества приложения</h2>
        <p className=" font-medium text-slate-700/600 pb-4 text-center text-2xl pb-30 mx-4" >Зарегистрируйтесь, чтобы использовать все возможности</p>
